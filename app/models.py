...
class Category(db.Model):
    ...
    seo_target_keyword = db.Column(db.String(160), default='')
    seo_product_rules = db.Column(db.Text, default='{}')
    seo_quality_score = db.Column(db.Integer, default=0)
    seo_last_generated_at = db.Column(db.DateTime, nullable=True)
...
class BlogPost(db.Model):
    ...
    meta_description = db.Column(db.String(320), default='')
    seo_title = db.Column(db.String(220), default='')
    target_keyword = db.Column(db.String(160), default='')
    related_product_ids = db.Column(db.Text, default='[]')
...
class ProductVariant(db.Model):
    ...
    # Interní SKU necháváme v poli sku. Dodavatelské údaje se doplní později importem CSV/XLSX.
    supplier_sku = db.Column(db.String(120), default='')
    supplier_color = db.Column(db.String(80), default='')
    supplier_product_code = db.Column(db.String(120), default='')
    supplier_ean = db.Column(db.String(80), default='')
    supplier_sync_status = db.Column(db.String(30), default='')
    supplier_sync_message = db.Column(db.Text, default='')
    supplier_synced_at = db.Column(db.DateTime, nullable=True)
    stock = db.Column(db.Integer, default=0)
