...
def ensure_schema_columns():
    ...
    desired = {
        ...
        'product_variant': {
            ...
            'supplier_color': "ALTER TABLE product_variant ADD COLUMN supplier_color VARCHAR(80) DEFAULT ''",
            'supplier_product_code': "ALTER TABLE product_variant ADD COLUMN supplier_product_code VARCHAR(120) DEFAULT ''",
            'supplier_ean': "ALTER TABLE product_variant ADD COLUMN supplier_ean VARCHAR(80) DEFAULT ''",
            'supplier_sync_status': "ALTER TABLE product_variant ADD COLUMN supplier_sync_status VARCHAR(30) DEFAULT ''",
            'supplier_sync_message': "ALTER TABLE product_variant ADD COLUMN supplier_sync_message TEXT DEFAULT ''",
            'supplier_synced_at': "ALTER TABLE product_variant ADD COLUMN supplier_synced_at DATETIME",
        },
        'coupon': None,
